...
##### Топология
![Topology.png](Configure&VerifyIPv4/images/Topology.png)
...
![R1-Checking](images/R1-Checking.png)
![R2-Checking](images/R2-Checking.png)
Все интерфейсы настроены согласно заданию и проверка связи прошла успешно.
![Connection](images/Connection-checking.png)
